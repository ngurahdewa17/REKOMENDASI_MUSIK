					...
					<div class="row">
						<div class="col-md-12">
							<ul class="nav nav-tabs">
							  <li role="presentation" class="active"><a href="tampilanadmin.php">Data Pelamar</a></li>
							...
							<div class="table-responsive">
								<table class="table table-hover">
	  								...
	  								<tr>
	  									...
	  									<td>
	  										<a class="btn btn-primary" href="ubah.php?id=<?= $row['id'] ;?>">Update</a>
	  										<a class="btn btn-primary" href="hapus.php?id=<?= $row['id']; ?>" onclick="return confirm('apakah data yakin untuk di hapus ?');">Delete</a>
	  									</td>
	  								</tr>
	  								<?php $i++ ;?>
	  								<?php endwhile; ?>
