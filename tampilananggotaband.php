					...
					<div class="row">
						<div class="col-md-12">
							<ul class="nav nav-tabs">
							  ...
							  <li role="presentation" class="active"><a href="tampilananggotaband.php">Data Anggota Band</a></li>
							  <li role="presentation"><a href="tampilandataterpilih.php">Informasi Band Terpilih</a></li>
							</ul>
						</div>
					</div>
					<h1>DATA USER</h1>
							...
							<div class="table-responsive">
								<table class="table table-hover">
	  								<tr>
	  									<th>No</th>
	  									<th>Nama Band</th>
	  									<th colspan="2">Detail Anggota Band</th>
	  								</tr>
	  								<?php $i=1 ;?>
	  								...
	  								<tr>
	  									...
	  									<td>
	  										<a href="#myModal" class="btn btn-primary btn-small" id="custId" data-toggle="modal" data-id="<?=$row["namapemain"];?>">Anggota Band</a>
	  									</td>
	  								</tr>
	  								<?php $i++ ;?>
	  								<?php endwhile; ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Anggota Band</h4>
                </div>
